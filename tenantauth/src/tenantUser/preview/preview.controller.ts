...
export class PreviewController {
  ...
  async finalSubmit(@Body() data: any) {
    ...
    // Then publish tenantIndustyDetails
    ...
    // First publish tenantUserDetails
    await channel.publish(
      exchange,
      'tenantUserDetails',
      Buffer.from(
    ...
    await channel.publish(
      ...
      // Then publish tenantOrganisationDetails
    setTimeout(() => {
      channel.publish(
       exchange,
     ...
     // Then publish tenantPocDetails after a delay of 500ms
