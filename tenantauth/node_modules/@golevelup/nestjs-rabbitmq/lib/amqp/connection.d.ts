...
export declare type SubscriberHandler<T = unknown> = (msg: T | undefined, rawMessage?: ConsumeMessage, headers?: any) => Promise<SubscribeResponse>;
...
export declare type ConsumerHandler<T, U> = (BaseConsumerHandler & {
    type: 'subscribe';
...
export declare class AmqpConnection {
    ...
    createSubscriber<T>(handler: SubscriberHandler<T>, msgOptions: MessageHandlerOptions, originalHandlerName: string): Promise<SubscriptionResult>;
