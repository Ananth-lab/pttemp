...
const pusers_service_1 = require("../users/pusers.service");
const tusers_service_1 = require("../users/tusers.service");
const util_1 = require("util");
const crypto_2 = require("crypto");
const scryptAsync = (0, util_1.promisify)(crypto_2.scrypt);
let AuthService = class AuthService {
    constructor(pusersService, tusersService, jwtService) {
    ...
    async validateUser(email, password) {
        ...
        if (user && storedHash == hash.toString("hex")) {
            const _a = user[0], { password, email } = _a, rest = __rest(_a, ["password", "email"]);
            return rest;
        }
        return null;
    }
...
AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [pusers_service_1.PusersService,
        tusers_service_1.TusersService,
        jwt_1.JwtService])
], AuthService);
