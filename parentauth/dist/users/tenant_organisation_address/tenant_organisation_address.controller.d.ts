...
export declare class TenantOrganisationAddressController {
    ...
    update(id: string, updateTenantOrganisationAddressDto: UpdateTenantOrganisationAddressDto): Promise<import("./entities/tenant_organisation_address.entity").TenantOrganisationAddress>;
