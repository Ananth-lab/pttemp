...
const privileges_controller_1 = require("./privileges.controller");
const privileges_service_1 = require("./privileges.service");
const privilege_entity_1 = require("./privilege.entity");
let PrivilegesModule = class PrivilegesModule {
};
PrivilegesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([privilege_entity_1.Privilege])],
        controllers: [privileges_controller_1.PrivilegesController],
        providers: [privileges_service_1.PrivilegesService],
    })
], PrivilegesModule);
